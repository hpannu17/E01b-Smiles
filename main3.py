...
smile_x,smile_y = (face_x + 0,face_y - 13)
eye1_x,eye1_y = (face_x - 30,face_y + 30) 
eye2_x,eye2_y = (face_x + 30,face_y + 30)
catch1_x,catch1_y = (face_x - 25,face_y + 40) 
catch2_x,catch2_y = (face_x + 35,face_y + 40) 
...
arcade.draw_ellipse_filled(eye1_x,eye1_y,28,48,open_color.black)
arcade.draw_ellipse_filled(eye2_x,eye2_y,28,48,open_color.black)
