...
for x in range(100,800,150):
        ...
        for y in range(100,600,150):
                face_x,face_y = (x,y)
                smile_x,smile_y = (face_x + 0,face_y - 18)
                eye1_x,eye1_y = (face_x - 28,face_y + 28) 
                eye2_x,eye2_y = (face_x + 28,face_y + 28)
                catch1_x,catch1_y = (face_x - 25,face_y + 31) 
                catch2_x,catch2_y = (face_x + 31,face_y + 31) 
