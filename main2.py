...
arcade.draw_ellipse_filled(face_x + -31, face_y + 39, 27, 50, open_color.black)
arcade.draw_ellipse_filled(face_x + 31, face_y + 39, 27, 50, open_color.black)
arcade.draw_circle_filled(face_x + -26, face_y + 49, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + 36, face_y + 49, 3, open_color.gray_2)
